       ////////////////////////////////////////////////////////////
      // Mixer Profile Viewer                                   //
     // Description: Mixer Profile Viewer using the mixer api! //  
    // Author: MSFTserver                                     //     
...
////////////////////////////////////////////////////////////
   ...
   ///////////////////////////////////////////////////////
  // original code in this file writin by FireBottleTV //
 //  Modified and debugged by: MSFTserver             //
///////////////////////////////////////////////////////
...
function channelLookup(username){
	...
	var cGameDescriptionSource = data.type.source;
        ...
        // Convert to Human
        if(cOnline === false || cOnline === "false"){
            var cOnline = 'offline';
        ...
        $('.video').html('<iframe width="600px" height="337.5px" src="https://mixer.com/embed/player/'+uUsername+'" style="border-color: cornflowerblue;"><p>Your browser does not support iframes.</p></iframe>');
        $('.chat').html('<iframe margin-top="-7px" width="600px" height="280px" src="https://mixer.com/embed/chat/'+uUsername+'" style="border-color: cornflowerblue;"><p>Your browser does not support iframes.</p></iframe>');    })
 
		var trimmedUsername = username.trim();
		// throw in profile links
		$('.links .direct .link').html('<a href="http://mixer.msft.online/lookup?username='+trimmedUsername+'">http://mixer.msft.online/lookup?username='+trimmedUsername+'</a>');
		$('.links .clean .link').html('<a href="http://mixer.msft.online/lookup?username='+trimmedUsername+'&clean=yes">http://mixer.msft.online/lookup?username='+trimmedUsername+'&clean=yes</a>');
		$('.links').show();
