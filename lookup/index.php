...
<head>
  ...
  <!--
  if (screen.width <= 800) {
    window.location = "http://mixer.msft.online/lookup-mobile/";
  }
  //-->
</script>
<script>
...
<body style="background-image: url(https://mixer.com/_latest/assets/img/backgrounds/wow-002.jpg?7b3b5f0);">
                    ...
                    <div class="left">
                         <div class="info channel-status">
                            <div class="channel-info">
                                <img src="http://i.imgur.com/NMf1RRd.png" style="width:60px;height:60px;float: left;padding-right: 10px;">
                                <p class="cOnline"></p>
                                <p class="cLink"></p>
                            </div>
